...
<!--begin::Aside-->
<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{ asset('log_in/assets/media/bg/bg-4.jpg') }});">
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
        <div class="kt-grid__item kt-grid__item--middle">
            <h3 class="kt-login__title">Welcome to LESA</h3>
            <h4 class="kt-login__subtitle">हर घर बिजली ।<br>
हर घर उजाला ।।<br>
अपना प्रदेश, उत्तम प्रदेश ।</h4>
        </div>
    </div>
    <div class="kt-grid__item">
        <div class="kt-login__info">
            <div class="kt-login__copyright">
                &copy <?php echo date('Y'); ?> Kaizen Training Solutions
            </div>
