...
<!--begin::Page Custom Styles(used by this page) --> 
 <link href="{{ asset('log_in/assets/css/demo8/pages/general/login/login-1.css') }}" rel="stylesheet" type="text/css" />
<!--end::Page Custom Styles -->

<!--begin::Global Theme Styles(used by all pages) -->
<link href="{{ asset('log_in/assets/vendors/global/vendors.bundle.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('log_in/assets/css/demo8/style.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<!--begin::Global Theme Bundle(used by all pages) -->
    ...
    <script src="{{ asset('log_in/assets/js/demo8/pages/login/login-1.js') }}" type="text/javascript"></script>
                <!--end::Page Scripts -->
    </body>
<!-- end::Body -->
